...
facerec = dlib.face_recognition_model_v1("./FaceInfomation/dlib_face_recognition_resnet_model_v1.dat")
...
# 处理存放所有人脸特征的 csv
path_features_known_csv = "./csv/features2_all.csv"
                ...
                if min(e_distance_list) < 0.4:
                    ...
                    for name in file_names:
                        ...
                        if sum == key_id:
                            ...
                            name_namelist[1:k] = name #人名删去第一个数字（用于视频输出标识）
                        key_id += 1
                    # 播放欢迎光临音效
                    语音测试.语音测试().say("欢迎光临"+name)
                    ...
                    for i, d in enumerate(faces):
                        ...
                        # 要存储visitor人脸图像文件的路径
                        path_visitors_save_dir = "./visitor/known"
                    ...
                    for i, d in enumerate(faces):
                        ...
                        path_visitors_save_dir = "./visitor/unknown"
